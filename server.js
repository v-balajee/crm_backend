...
async function init() {
  ...
  try {
    user = await User.create({
      ...
      email: "baluvasamsetti@gmail.com", // If we don't pass this, it will throw the error
      userType: "ADMIN",
      password: bcrypt.hashSync("balajee", 8), //this field should be hidden from the end user
    });
    console.log(user);
  } catch (e) {
